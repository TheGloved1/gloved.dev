...
export async function loader() {
  console.log(process.env.NEXT_CLIENT_FILE_MANAGER_PASSKEY);
}

export default function FileUploader(): React.JSX.Element {
  const correctPassword = import.meta.env.VITE_CLIENT_FILE_MANAGER_PASSKEY ?? '7693' // Don't care about security here
