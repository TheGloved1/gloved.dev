import { type Message } from '$lib/dexie';
...
export const Models = Object.freeze([
	...
	},
	{
		...
		enabled: true,
		description:
			"Google's hybrid reasoning model, with a 1M token context window and thinking budgets.",
		requirements: {
			loggedIn: true,
			admin: true
		},
	...
	},
	{
		...
		enabled: true,
		description:
			"Google's advanced reasoning model, which excels at coding and complex reasoning tasks",
		requirements: {
			loggedIn: true,
			admin: true
		},
	...
	},
	{
		...
		enabled: true,
		description:
			'Lightweight version of Llama 3 optimized for fast responses and efficient inference',
		requirements: {
			loggedIn: true,
			admin: true
		},
