    ...
    <form onSubmit={handleSubmit} className='space-y-4'>
      <div className='relative'>
        <input
          ...
          className='w-full rounded-xl border-2 border-red-900/30 bg-black px-4 py-4 text-lg text-red-300 transition-colors placeholder:text-red-600/50 focus:border-red-500/50 focus:outline-none'
          maxLength={100}
      ...
      <button
        type='submit'
        className='touch-manipulation-none min-h-[48px] w-full rounded-xl bg-red-600 py-3 text-base font-medium text-white transition-colors hover:bg-red-500 disabled:cursor-not-allowed disabled:opacity-50'
